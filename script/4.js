...
function disable(z){
	...
	a = document.getElementById('empty1').innerHTML + document.getElementById('empty2').innerHTML +  document.getElementById('empty3').innerHTML ;
	var t=a.length
	if(t<=4){
...
function emp(x){
	...
	for (i=1;i<=6;i++){
		...
		if (document.getElementById('empty'+i).innerHTML == ''){
		 ...
		 b = document.getElementById('empty1').innerHTML + document.getElementById('empty2').innerHTML +  document.getElementById('empty3').innerHTML ;
